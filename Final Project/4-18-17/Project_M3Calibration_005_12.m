function [SSE] = Project_M3Calibration_005_12(yl, yH, Tau, Ts, data, timeLabel, counter)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
approximation = 0; %Initialize variable, approximation.
...
approximation = 0; %Initialize variables
counter = 1;
